...
#include "dynamixel_sdk_custom_interfaces/msg/detail/set_position_arr__rosidl_typesupport_fastrtps_c.h"
...
using _SetPositionArr__ros_msg_type = dynamixel_sdk_custom_interfaces__msg__SetPositionArr;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SetPositionArr__ros_msg_type * ros_message = static_cast<const _SetPositionArr__ros_msg_type *>(untyped_ros_message);
  // Field name: ids
  {
  ...
  void * untyped_ros_message)
{
  ...
  _SetPositionArr__ros_msg_type * ros_message = static_cast<_SetPositionArr__ros_msg_type *>(untyped_ros_message);
  // Field name: ids
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
...
size_t get_serialized_size_dynamixel_sdk_custom_interfaces__msg__SetPositionArr(
  const void * untyped_ros_message,
...
static uint32_t _SetPositionArr__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dynamixel_sdk_custom_interfaces__msg__SetPositionArr(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dynamixel_sdk_custom_interfaces
size_t max_serialized_size_dynamixel_sdk_custom_interfaces__msg__SetPositionArr(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dynamixel_sdk_custom_interfaces__msg__SetPositionArr;
    is_plain =
      (
...
static size_t _SetPositionArr__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dynamixel_sdk_custom_interfaces__msg__SetPositionArr(
...
static message_type_support_callbacks_t __callbacks_SetPositionArr = {
...
static rosidl_message_type_support_t _SetPositionArr__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SetPositionArr,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dynamixel_sdk_custom_interfaces, msg, SetPositionArr)() {
  return &_SetPositionArr__type_support;
}
