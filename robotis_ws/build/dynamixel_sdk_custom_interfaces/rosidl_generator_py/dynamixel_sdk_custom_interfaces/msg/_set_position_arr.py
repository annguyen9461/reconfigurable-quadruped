...
class Metaclass_SetPositionArr(type):
    """Metaclass of message 'SetPositionArr'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'dynamixel_sdk_custom_interfaces.msg.SetPositionArr')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__set_position_arr
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__set_position_arr
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__set_position_arr
            cls._TYPE_SUPPORT = module.type_support_msg__msg__set_position_arr
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__set_position_arr
...
class SetPositionArr(metaclass=Metaclass_SetPositionArr):
    """Message class 'SetPositionArr'."""
